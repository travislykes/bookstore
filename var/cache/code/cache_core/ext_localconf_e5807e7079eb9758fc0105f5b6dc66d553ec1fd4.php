...
/**
 * Extension: bookstore_site
 * File: /var/www/html/public/typo3conf/ext/bookstore_site/ext_localconf.php
 */

$_EXTKEY = 'bookstore_site';
$_EXTCONF = $GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf'][$_EXTKEY] ?? null;
 ...
 */
$GLOBALS['TYPO3_CONF_VARS']['RTE']['Presets']['bookstore_site'] = 'EXT:bookstore_site/Configuration/RTE/Default.yaml';
